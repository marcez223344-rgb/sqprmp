...
```json
{
  ...
  "options": [
    {
      "key": "a",
      "body_md": "`WHERE` filtra filas antes de agrupar; `HAVING` filtra grupos después de agregar.",
      "is_correct": true
    },
    {
      "key": "b",
      "body_md": "Son sinónimos; se puede usar cualquiera.",
      "is_correct": false,
      "why_incorrect_md": "No lo son: `HAVING` puede usar agregados y `WHERE` no."
    },
    {
      "key": "c",
      "body_md": "`HAVING` solo funciona con `COUNT`.",
      "is_correct": false,
      "why_incorrect_md": "Funciona con cualquier expresión, incluidos otros agregados."
    },
    {
      "key": "d",
      "body_md": "`WHERE` no puede combinarse con `GROUP BY`.",
      "is_correct": false,
      "why_incorrect_md": "Sí puede; de hecho es la forma habitual de filtrar antes de agrupar."
    }
  ],
