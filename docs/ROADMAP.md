...
- **2026-09-24: section 39 «SQL con IA» added (D-40); the capstone is now section 40.** 40 of 40 sections published, 362 lessons, 444 theory questions, 218 exercises (`content:validate`). The certificate «Analista SQL Profesional» now requires it (migration `20260924140000`).
