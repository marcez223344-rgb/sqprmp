...
| F5  | He must be able to approve production database changes by answering in the conversation, not by running commands himself | Done — standing rule; the certificate rule (OA-27) was applied that way on 2026-09-25                                                                                                        |
| F6  | «Verificador de IA» badge: build it now                                                                                  | Shipped, unverified — live since 2026-09-25 after his yes in conversation (migration `20260925120000`, verified read-only: 13 active badges)                                                 |
| F7  | Why does the home say «6 niveles» and /ruta show 4?                                                                      | Shipped, unverified — /ruta, /curriculo, /perfil and the landing now show the 6 course levels (D-41)                                                                                         |
| F8  | Stop typing the section count by hand                                                                                    | Shipped, unverified — counted from the catalogue (D-41)                                                                                                                                      |
