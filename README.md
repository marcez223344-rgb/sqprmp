...
> Estado actual: **Fase 1 (fundación) completada** — proyecto Next.js 16, sistema de diseño, i18n, clientes Supabase, primera migración con RLS, pruebas y CI. Ver [docs/ROADMAP.md](docs/ROADMAP.md).
